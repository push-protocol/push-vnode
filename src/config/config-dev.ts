...
const deployedCommunicatorContracts = {
  ethereumAddress: '0x9dDCD7ed7151afab43044E4D694FA064742C428c',
  polygonAddress: '0x9cb3bd7550B5c92baA056Fc0F08132f49508145F',
  bscAddress: '0x4132061E3349ff36cFfCadA460E10Bd4f31F7ea8',
  arbitrumAddress: '0x754787358fac861ef904c92d54f7adb659779317',
  optimismAddress: '0x754787358faC861ef904c92D54f7Adb659779317',
  polygonZkEVMAddress: '0x9cb3bd7550b5c92baa056fc0f08132f49508145f',
  fuseAddress: '0x7eBb54D86CF928115965DB596a3E600404dD8039',
  lineaAddress: '0x9cb3bd7550B5c92baA056Fc0F08132f49508145F',
  cyberConnectAddress: '0x9cb3bd7550B5c92baA056Fc0F08132f49508145F',
  berachainAddress: '0xA1DF3E68D085aa6918bcc2506b24e499830Db0eB',
  baseAddress: '0x9cb3bd7550B5c92baA056Fc0F08132f49508145F'
}
...
const configDev: ConfigEnvironment = {
   ...
   */
  protocolMeta: [
    { row: `${sourceIds.ethereumId}`, genesisBlock: 4619592 }, //ethereum
    { row: `${sourceIds.polygonId}`, genesisBlock: 4663913 }, //polygon amoy
    { row: `${sourceIds.bscId}`, genesisBlock: 25296872 }, //bsc
    // {row: `${sourceIds.fvmId}`, genesisBlock: 910} , //fvm
    { row: `${sourceIds.arbitrumId}`, genesisBlock: 18237555 }, // Arbitrum
    { row: `${sourceIds.optimismId}`, genesisBlock: 8658172 }, // Optimism
    { row: `${sourceIds.polygonZkEVMId}`, genesisBlock: 2496029 }, // zkEVM cardona
    { row: `${sourceIds.fuseId}`, genesisBlock: 13526026 }, // fuse
    { row: `${sourceIds.lineaChainId}`, genesisBlock: 17527 }, // linea
    { row: `${sourceIds.cyberconnectId}`, genesisBlock: 489026 }, // cyber connect
  ...
  // deployedCommunicatorContractFvm:"0x5a0D108dd58911DE6638889E1F7a40Cd133daaE2",
  ...
  deployedCommunicatorContractABI: require('./epns_communicator_dev.json'),

  // PUSH CORE CONTRACTS
  deployedCoreContract: '0x5ab1520e2bd519bdab2e1347eee81c00a77f4946',
  deployedCoreContractABI: require('./epns_core_dev.json'),
  ...
  MAP_ID_TO_COMM_CONTRACT: {
    ...
    // 3141: "0x5a0D108dd58911DE6638889E1F7a40Cd133daaE2",
  ...
  /** NPIP Block Genesis*/
  NPIPImplemenationBlockEth: 4619592,
  NPIPImplemenationBlockPolygon: 4663913,
  NPIPImplemenationBlockBsc: 25296872,
  // NPIPImplemenationBlockFvm: 25296872 ,
  NPIPImplemenationBlockArbitrum: 18237555,
  NPIPImplemenationBlockOptimism: 8658172,
  NPIPImplemenationBlockPolygonZkEVM: 2496029,
  NPIPImplemenationBlockFuse: 13526026,
  NPIPImplementationBlockCyberConnect: 489026,
  NPIPImplemenationBlockBerachain: 572465,
  NPIPImplemenationBlockLinea: 17527,
