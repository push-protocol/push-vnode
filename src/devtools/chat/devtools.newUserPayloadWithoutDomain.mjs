...
const getChainIdAndVerifyingContract = (source) => {
  //   if (source == config.default.ethereumId || source == config.default.graphId)
  return {
    chainId: config.default.ethereumChainId,
    verifyingContract: config.default.deployedCommunicatorContractEthereum
  }
  //   else if (source == config.default.polygonId)
  //     return {
  //       chainId: config.default.polygonChainId,
  //       verifyingContract: config.default.deployedCommunicatorContractPolygon,
  //     };
}
